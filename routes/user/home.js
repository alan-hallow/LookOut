...
router.get("/", (req, res) => {
  ...
  res.render("user/home", { body: "hello", username: username }); // Render the home template with the username retrieved from the session
});
...
router.get("/signin", (req, res) => {
  ...
  res.render("user/signin", { errorMessage: { passwordError, emailError } }); // Render the signin template initially
});
